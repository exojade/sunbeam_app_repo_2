...
insert  into `enrollment`(`enrollment_id`,`dateEnrolled`,`syid`,`student_id`,`grade_level`,`advisory_id`,`status`,`credit_balance`) values 
('ENR388DEA392F02F','2024-07-28 09:21:30','SY1','LRN40559200000001','Grade 1','ADV166E9C96EBEE0','PENDING',NULL);

...
use PhpOffice\PhpSpreadsheet\Worksheet\Drawing;
    if($_SERVER["REQUEST_METHOD"] === "POST") {
		if($_POST["action"] == "bank_settings_datatable"):
			// dump($_POST);
			...
			$baseQuery = "select * from bankdetails";
			if($search == ""):
			...
			foreach($data as $row):
				$data[$i]["action"] = '
						<a href="#" data-toggle="modal" data-target="#modalUpdateBankDetails" data-id="'.$row["tblid"].'" class="btn btn-block btn-sm btn-warning">Update</a>
				';
		...
		if(!isset($_GET["action"])):
			render("public/bank_settings_system/bank_settings_page.php",[
			]);
		else:
			if($_GET["action"] == "new"):

...
CREATE TABLE `captureform137` (
  `form137_id` int(100) NOT NULL AUTO_INCREMENT,
...
(2,'RIZAL ELEM SCHOOL','123123','2','PANABO','XI','Grade 1','1','2022-2023','RODRIGO DUTERTE','LRN40559200000011');
...
insert  into `captureform137_grades`(`tblid`,`form137_id`,`subject`,`first_grading`,`second_grading`,`third_grading`,`fourth_grading`,`final_rating`,`remarks`,`student_id`,`order_grades`,`order_parent`) values 
(3,'2','Math','88','89','90','77','86.00','Passed','LRN40559200000011',1.0,NULL),
(4,'2','English','90','90','90','90','90.00','Passed','LRN40559200000011',2.0,NULL),
(5,'2','MAPEH','99','90','88','90','91.75','Passed','LRN40559200000011',3.0,NULL),
(6,'2','Music','90','90','90','90','90.00','Passed','LRN40559200000011',3.1,NULL),
(7,'2','Arts','90','91','89','90','90.00','Passed','LRN40559200000011',3.2,NULL),
(8,'2','Physical Education','91','90','90','99','92.50','Passed','LRN40559200000011',3.3,NULL),
(9,'2','Health','88','88','90','76','85.50','Passed','LRN40559200000011',3.4,NULL);
...
CREATE TABLE `enrollment_requirements` (
  `tblid` int(100) NOT NULL AUTO_INCREMENT,
  `enrollment_id` varchar(100) DEFAULT NULL,
...
('SUBJ03FFC88B2BF69','English 2','Intro to English','Intro to English','3','PARENT',NULL),
('SUBJA9AC3763B1105','Aral Pan','Buhay sa Mesopotamia','Buhay sa Mesopotamia','6','PARENT',NULL);
